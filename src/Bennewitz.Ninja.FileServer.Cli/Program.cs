...
public static class Program
{
    ...
    private static async Task Start(string[] args)
    {
        ...
        // wwwroot now lives in the component assembly, so the manifest must be read from there
        // rather than from this executable.
        app.Environment.WebRootFileProvider =
            new ManifestEmbeddedFileProvider(typeof(FileServerMountOptions).Assembly, "wwwroot");
